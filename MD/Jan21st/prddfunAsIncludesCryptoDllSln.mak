...
$(OBJPATH)\$(APP)ddfun-cryptoDll.lib:  prddfun-cryptoDll.cpp prddfun-cryptoDll.h
    devenv "$(PROJPATH)\Source\Views\cryptoSln\prddfun-cryptoDll.sln" /rebuild Release /project "(PROJPATH)\Source\Views\cryptoSln\prddfun-cryptoDll.vcproj" /projectconfig Release
	copy $(PROJPATH)\Source\Views\cryptoSln\Release\$(APP)ddfun-cryptoDll.lib $(OBJPATH)
	copy $(PROJPATH)\Source\Views\cryptoSln\Release\$(APP)ddfun-cryptoDll.dll $(RUNPATH)
