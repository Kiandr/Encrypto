...
rem devenv "$(PROJPATH)\Views\crypto\prddfun-cryptoDll.sln" /Deploy "Release|Win32" /out "$(PROJPATH)\Source\Views\crypto\logSln.txt" /project "$(PROJPATH)\Source\Views\crypto\prddfun-cryptoDll.vcproj" /projectconfig "Release|Win32" /Log "$(PROJPATH)\Source\Views\crypto\logVcProj.txt"
